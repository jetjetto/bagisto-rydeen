...
<body>
    <div class="container">
        <h1>New Dealer Order Received</h1>

        <p>A new order has been placed by <strong>{{ $order->customer_first_name }} {{ $order->customer_last_name }}</strong> ({{ $order->customer_email }}).</p>
